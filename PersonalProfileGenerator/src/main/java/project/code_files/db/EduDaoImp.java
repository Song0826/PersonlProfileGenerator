...
import project.code_files.bean.Edu;
...
public class EduDaoImp implements BaseDao<Edu> {
    ...
    private static final String SQL_INSERT = "insert into edu(userid,start,end,school,study,description) values(?,?,?,?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from edu where userid=? order by start";
