...
public class SpecialtyDaoImp implements BaseDao<Specialty> {
    ...
    private static final String SQL_INSERT = "insert into specialty(userid,name,description) values(?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from specialty where userid=?";
